<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankPayment.aspx.cs" Inherits="SyaSyaDesign.BankPayment" %>
...
<body>
    ...
    <form id="form1" runat="server" style="margin-bottom:0px; height: 100%">
                ...
                <div class="justify-content-center ">
                    <asp:Table ID="TablePaymentDetails" runat="server" ClientIDMode="Static" CellPadding="10" CellSpacing="10">
                        ...
                        <asp:TableRow ID="PAC" Visible="false">
                            ...
                            <asp:TableCell> : </asp:TableCell>
                            <asp:TableCell>
                                <asp:TextBox runat="server" ID="TxtPAC" autocomplete="off"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
